...
var pactffi_create_mock_server_for_pact func(uint16, string, bool) int32
var pactffi_create_mock_server_for_transport func(uint16, string, uint16, string, string) int32
...
var pactffi_free_string func(string)
var pactffi_new_pact func(string, string) uint16
var pactffi_pact_handle_to_pointer func(uint16) uintptr
var pactffi_new_interaction func(uint16, string) uint32
var pactffi_new_message_interaction func(uint16, string) uint32
var pactffi_new_sync_message_interaction func(uint16, string) uint32
var pactffi_upon_receiving func(uint32, string) bool
var pactffi_given func(uint32, string) bool
var pactffi_interaction_test_name func(uint32, string) uint32
var pactffi_given_with_param func(uint32, string, string, string) bool
var pactffi_given_with_params func(uint32, string, string) int32
var pactffi_with_request func(uint32, string, string) bool
var pactffi_with_query_parameter func(uint32, string, size_t, string) bool
var pactffi_with_query_parameter_v2 func(uint32, string, size_t, string) bool
var pactffi_with_specification func(uint16, int32) bool
var pactffi_handle_get_pact_spec_version func(uint16) int32
var pactffi_with_pact_metadata func(uint16, string, string, string) bool
var pactffi_with_header func(uint32, int32, string, size_t, string) bool
var pactffi_with_header_v2 func(uint32, int32, string, size_t, string) bool
var pactffi_set_header func(uint32, int32, string, string) bool
var pactffi_response_status func(uint32, uint16) bool
var pactffi_response_status_v2 func(uint32, string) bool
var pactffi_with_body func(uint32, int32, string, string) bool
var pactffi_with_binary_body func(uint32, int32, string, uintptr, size_t) bool
var pactffi_with_binary_file func(uint32, int32, string, uintptr, size_t) bool
...
var pactffi_with_multipart_file func(uint32, int32, string, string, string) uintptr
var pactffi_pact_handle_get_message_iter func(uint16) uintptr
var pactffi_pact_handle_get_sync_message_iter func(uint16) uintptr
var pactffi_pact_handle_get_sync_http_iter func(uint16) uintptr
var pactffi_new_message_pact func(string, string) uint16
var pactffi_new_message func(uint16, string) uint32
var pactffi_message_expects_to_receive func(uint32, string)
var pactffi_message_given func(uint32, string)
var pactffi_message_given_with_param func(uint32, string, string, string)
var pactffi_message_with_contents func(uint32, string, uintptr, size_t)
var pactffi_message_with_metadata func(uint32, string, string)
var pactffi_message_with_metadata_v2 func(uint32, string, string)
var pactffi_message_reify func(uint32) string
var pactffi_write_message_pact_file func(uint16, string, bool) int32
var pactffi_with_message_pact_metadata func(uint16, string, string, string)
...
var pactffi_using_plugin func(uint16, string, string) uint32
var pactffi_cleanup_plugins func(uint16)
var pactffi_interaction_contents func(uint32, int32, string, string) uint32

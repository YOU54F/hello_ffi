...
namespace Routeguide
{
    class Program
    {
        ...
        {
            var channel = GrpcChannel.ForAddress("http://127.0.0.1:5099");
...
// using Grpc.Net.Client;
// using RouteGuideClient;

// public class RouteGuideClientWrapper
// {
//     private readonly RouteGuide.RouteGuideClient _client;

//     public RouteGuideClientWrapper(string url)
//     {
//         var channel = GrpcChannel.ForAddress(url);
//         _client = new RouteGuide.RouteGuideClient(channel);
//     }

//     public Feature GetFeature(int latitude, int longitude)
//     {
//         var reply = _client.GetFeature(new Point { Latitude = latitude, Longitude = longitude });
//         return reply;
//     }
// }
...
//     {
//         var client = new RouteGuideClientWrapper("http://localhost:5099");
//         var greeting = client.GetFeature(407838351,-746143763);
